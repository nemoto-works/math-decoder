...
const steps = [
  {
    ...
    focus: ['d1', 'd5'],
    preview: ['q1'],
    q1: '', q3: '', show12: false, show3: false, show36: false, showSecond36: false, show0: false,
  ...
  },
  {
    ...
    focus: ['q1'],
    preview: ['m1', 'm2'],
    q1: '1', q3: '', show12: false, show3: false, show36: false, showSecond36: false, show0: false,
  ...
  },
  {
    ...
    focus: ['m1', 'm2'],
    preview: ['r3'],
    q1: '1', q3: '', show12: true, show3: false, show36: false, showSecond36: false, show0: false,
  ...
  },
  {
    ...
    focus: ['r3'],
    preview: ['d6'],
    q1: '1', q3: '', show12: true, show3: true, show36: false, showSecond36: false, show0: false,
    visualTitle: '残りは3',
  ...
  },
  {
    ...
    focus: ['r3', 'd6'],
    preview: ['q3'],
    q1: '1', q3: '', show12: true, show3: false, show36: true, showSecond36: false, show0: false,
    visualTitle: '3 + 6 → 36',
  ...
  },
  {
    ...
    focus: ['q3'],
    preview: ['p3', 'p6'],
    q1: '1', q3: '3', show12: true, show3: false, show36: true, showSecond36: false, show0: false,
  ...
  },
  {
    ...
    focus: ['q1', 'q3'],
    preview: [],
    q1: '1', q3: '3', show12: true, show3: false, show36: true, showSecond36: true, show0: true,
    visualTitle: '筆算の流れ',
...
function SvgDigit({ id, x, y, children, step }) {
  ...
  return (
    <g className={cx(preview && 'svg-preview', active && 'svg-spotlight')}>
      {(active || preview) && <rect x={x - 18} y={y - 34} width="36" height="42" rx="8" />}
      <text x={x} y={y}>{children}</text>
    </g>
  );
}
...
function LongDivision({ step }) {
  return (
    <div className="spotlight-stage">
      <svg className="division-svg" viewBox="0 0 320 340" role="img" aria-label="156 ÷ 12 の筆算">
        <line className="division-line" x1="132" y1="78" x2="268" y2="78" />
        <path className="division-line no-fill" d="M122 82 C136 112 136 138 122 168" />

        <SvgDigit id="q1" x="190" y="54" step={step}>{step.q1}</SvgDigit>
        <SvgDigit id="q3" x="235" y="54" step={step}>{step.q3}</SvgDigit>

        <text className="svg-digit divisor-svg" x="82" y="130">12</text>
        <SvgDigit id="d1" x="150" y="130" step={step}>1</SvgDigit>
        <SvgDigit id="d5" x="195" y="130" step={step}>5</SvgDigit>
        <SvgDigit id="d6" x="240" y="130" step={step}>6</SvgDigit>

        {step.show12 && <>
          <SvgDigit id="m1" x="150" y="178" step={step}>1</SvgDigit>
          <SvgDigit id="m2" x="195" y="178" step={step}>2</SvgDigit>
          <line className="division-line" x1="132" y1="193" x2="215" y2="193" />
        </>}

        {step.show3 && <SvgDigit id="r3" x="195" y="232" step={step}>3</SvgDigit>}
        {step.show36 && <>
          <SvgDigit id="r3" x="195" y="232" step={step}>3</SvgDigit>
          <SvgDigit id="d6" x="240" y="232" step={step}>6</SvgDigit>
        </>}

        {step.showSecond36 && <>
          <SvgDigit id="p3" x="195" y="278" step={step}>3</SvgDigit>
          <SvgDigit id="p6" x="240" y="278" step={step}>6</SvgDigit>
          <line className="division-line" x1="178" y1="293" x2="260" y2="293" />
        </>}
        {step.show0 && <SvgDigit id="z0" x="240" y="326" step={step}>0</SvgDigit>}
      </svg>
    </div>
  );
}
    ...
    <section className="card quiz-card">
      ...
      <div className="quiz-options">
        {quiz.options.map((option) => (
          <button key={option.value} type="button" className={cx('quiz-option', choice === option.value && (isCorrect ? 'correct' : 'wrong'))} onClick={() => setChoice(option.value)}>{option.label}</button>
        ))}
      </div>
